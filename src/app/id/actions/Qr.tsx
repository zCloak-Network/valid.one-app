...
export default function () {
  ...
  return (
    <div className="w-full">
      <button className="btn w-full bg-white bg-opacity-20 rounded-lg text-white border-none" onClick={openModal}>
        <QrIcon />
        QR Code
      </button>
        ...
        <div className="modal-box w-[90vw] sm:max-w-[460px]">
          ...
          <div className="py-12 flex flex-col items-center gap-6">
            <div className="flex flex-col items-center gap-2">
              ...
              <span className="text-gray-800 text-base font-semibold">{User.profile?.name}</span>
            ...
            <QRCodeGenerator cellSize={180} url="https://zkid.app/" />
          </div>
        </div>
      </dialog>
    </div>
