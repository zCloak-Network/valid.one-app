    ...
    <div>
      ...
      <div className="bg-white border flex flex-col border-blue-950 rounded-2xl h-56 pb-4 overflow-hidden">
        ...
        <div className="flex flex-col h-full text-sm px-4 pt-4 text-gray-900 justify-between">
          ...
          <button className="rounded-xl bg-gray-800 text-white w-full p-2">Setup Profile</button>
        </div>
      </div>

      <div>
        <button className="rounded bg-blue-500 text-white p-2" onClick={() => setDrawerOpen(true)}>
          Open Drawer
        </button>
